...
选择安装路径
![01](01.png)
接着一直下一步，提示python版本不满足>=3.6，可以先忽略安装。
...
####  3.设置环境变量
进入C:\Program Files (x86)\Intel\openvino_2021.1.110\bin目录下，运行setupvars.bat
![03](03.png)

####  4.配置模型优化器
进入C:\Program Files (x86)\Intel\openvino_2021.1.110\deployment_tools\model_optimizer\install_prerequisites目录运行install_prerequisites.bat
![04](04.png)
...
```
####  6.运行截图
进入目录C:\Program Files (x86)\Intel\openvino_2021.1.110\deployment_tools\demo
运行demo_security_barrier_camera.bat
![05](05.png)
